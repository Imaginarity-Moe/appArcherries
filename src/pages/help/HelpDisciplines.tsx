...
function SubSection({ title, defaultOpen = false, children }: { title: string; defaultOpen?: boolean; children: React.ReactNode }) {
  ...
  return (
    <details open={open} onToggle={(e) => setOpen((e.currentTarget as HTMLDetailsElement).open)} className="group">
      ...
      <div className="pt-1.5 pl-5 text-sm space-y-2">{children}</div>
    </details>
  );
}
  ...
  return (
    <div className="space-y-7">
      ...
      <p className="text-secondary text-sm">
        Bogensport wird in drei großen Familien geschossen: <b>3D-Parcours</b> (Tier­attrappen im Wald),
      ...
      <section className="space-y-3">
        ...
        >
          <p className="text-primary mb-2">
            Punkte hängen von <b>Trefferzone</b> ab (Inner Kill → Outer Kill → Wound), und beim
            IFAA-System zusätzlich davon, ob du mit dem 1., 2. oder 3. Pfeil getroffen hast.
          </p>
        ...
        <SubSection title="Welche 3D-Wertungssysteme gibt es?">
          <p>Die App unterstützt fünf 3D-Wertungen. Welches du nutzt, ist Sache des Veranstalters:</p>
          ...
          <p className="text-secondary text-xs italic">Details + Rechenbeispiele siehe Sektion „Wertungssysteme".</p>
        </SubSection>
        ...
        <SubSection title="Tipps für Anfänger">
          <ul className="list-disc pl-5 space-y-1">
            <li><b>Distanz schätzen ist die halbe Miete.</b> Auf den ersten 5–10 Bahnen bewusst trainieren — die App speichert deine Schätzdistanzen pro Bahn-Tier.</li>
            <li><b>Pflock nicht überschießen.</b> Die Fußspitzen müssen direkten Bodenkontakt zum Pflock haben. Manche Parcours haben strikte Regeln.</li>
            <li><b>Pfeil-Verlust ist normal.</b> Plane 2–3 Verlustpfeile pro Jahr ein. In den Pfeil-Sets der App kannst du Verluste und Defekte mitführen.</li>
            <li><b>Auf öffentlichen Parcours</b> kannst du Reviews lesen und vorab Fotos der Bahnen ansehen — wenn andere User welche hochgeladen haben.</li>
          </ul>
        </SubSection>
      </section>
      ...
      <section className="space-y-3">
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          ...
          >
            ...
            <p className="text-secondary text-xs mb-1.5">24 Scheiben × 4 Pfeile = 96 Pfeile gesamt</p>
          ...
          >
            ...
            <p className="text-secondary text-xs mb-1.5">28 Scheiben × 4 Pfeile</p>
            <ul className="text-xs space-y-0.5">
