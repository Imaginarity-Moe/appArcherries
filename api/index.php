...
try {
    if (str_starts_with($path, '/auth/')) {
    ...
    } elseif (str_starts_with($path, '/equipment')) {
        require __DIR__ . '/routes/equipment.php';
        handle_equipment($method, $path);
        ...
        handle_notifications($method, $path);
    } elseif (str_starts_with($path, '/highscore')) {
        require __DIR__ . '/routes/highscore.php';
        handle_highscore($method, $path);
    } elseif (str_starts_with($path, '/clubs')) {
        require __DIR__ . '/routes/clubs.php';
        handle_clubs($method, $path);
